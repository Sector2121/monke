...
public class Main {
	public static void main(String[] args) throws Exception {
	    ...
	    System.out.print("Adja meg milyen fajta tesztelest szeretne csinalni(kezi, kesz): ");
		String[] cmd = null;
		try {
		...
		if (cmd.length == 0 || cmd[0].equals("")) {
			 ...
			 System.out.print("Mely tesztet szeretne futtatni? ");
				try {
					cmd = br.readLine().split(" ");
				} catch (IOException e) {
					System.out.println(e);
	    	...
	    	ell.TesztBeolvaso(cmd[0]);
	    	//itt meg kell ujra csinalni hogy soronkent beolvas es megcsinalja a parancsokat mint alul, de ezt megbeszeljuk egyaltalan eddig jo-e
	    	ell.Ellenorzo(tesztnev);
	    }
